...
type Config struct {
	...
	CallbackBaseURL string // Base URL for Browser Post callbacks (e.g., "http://localhost:8080")
...
func LoadConfig() (*Config, error) {
	cfg := &Config{
		ServiceURL:      getEnv("SERVICE_URL", "http://localhost:8081"),       // Server URL (ConnectRPC + REST)
