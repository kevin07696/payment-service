...
INSERT INTO chargebacks (
    ...
    sqlc.arg(id), sqlc.arg(transaction_id), sqlc.arg(merchant_id), sqlc.narg(customer_id),
...
SELECT * FROM chargebacks
WHERE merchant_id = sqlc.arg(merchant_id) AND case_number = sqlc.arg(case_number);
