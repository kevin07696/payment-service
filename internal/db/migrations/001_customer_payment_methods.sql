...
CREATE TABLE IF NOT EXISTS customer_payment_methods (
    ...
    -- Multi-tenant: which agent/merchant + which customer
    ...
    CONSTRAINT unique_payment_token UNIQUE (agent_id, customer_id, payment_token)
);

-- Indexes for performance
CREATE INDEX idx_customer_payment_methods_agent_customer ON customer_payment_methods(agent_id, customer_id);
CREATE INDEX idx_customer_payment_methods_agent_id ON customer_payment_methods(agent_id);
...
CREATE INDEX idx_customer_payment_methods_is_default ON customer_payment_methods(agent_id, customer_id, is_default) WHERE is_default = true;
